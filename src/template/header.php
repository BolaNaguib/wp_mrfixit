        ...
        <div class="uk-navbar-right">
          ...
          <ul class="uk-navbar-nav uk-visible@m  uk-flex uk-flex-middle">
            <?php if (have_rows('menu', 'option')) : ?>
              <?php while (have_rows('menu', 'option')) : the_row(); ?>
                ...
                <?php endif; ?>
              <?php endwhile; ?>
              <li> <a class="nav__link-quote changedNumberIcon " href="tel:<?php echo $phone; ?>"> <svg style="width: 15px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-phone fa-w-16">
                    <path fill="currentColor" d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z" class=""></path>
                  </svg> <span class="changedNumberspan"> <?php echo $phone_display; ?> </span> </a></li>
            <?php endif; ?>
          ...
          <ul class="uk-navbar-nav uk-hidden@m  uk-flex-middle uk-flex">
            <li>
              ...
              <button class="button_type_toggle" aria-label="menu" type="button">
            ...
            <li style="list-style: none;"> <a class="nav__link-quote changedNumberIcon" href="tel:<?php echo $phone; ?>">
