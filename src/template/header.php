        ...
        <div class="uk-navbar-right">
          ...
          <ul class="uk-navbar-nav uk-hidden@m  uk-flex-middle uk-flex">
            <li>
              ...
              <!-- <div class="uk-open" uk-dropdown="mode: click">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</div> uk-open -->
              <div class="navbar_type-dropdown uk-navbar-dropdown" uk-dropdown="mode: click;pos: bottom-justify; boundary: .boundary-align; boundary-align: true" style="display: none;">
                <ul class="uk-nav ">
                  <?php if (have_rows('menu', 'option')) : ?>
                    <?php while (have_rows('menu', 'option')) : the_row(); ?>
                      <?php if (get_row_layout() == 'pages') : ?>
