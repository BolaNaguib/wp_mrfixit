...
<!-- START section Hero -->
<section class='uk-visible@m section_type-hero uk-flex uk-flex-middle  <?php if ($full_width) : ?> full-width <?php else : ?> <?php endif; ?>' style="background-image: url('<?php echo $hero_background['url']; ?>');" >
  ...
  <div class='uk-container uk-position-relative' style="z-index: 9;">
    ...
    <div class='uk-text-center'>
      ...
      <br>
      <div>
        <a class="callback" href="<?php echo $phone; ?>"><?php echo $phone_display; ?></a>
      </div>
      <div>
        <br>
        <br>
...
<!-- START section Hero -->
<section class='uk-hidden@m section_type-hero uk-flex uk-flex-middle  <?php if ($full_width) : ?> full-width <?php else : ?> <?php endif; ?>' style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/hero-mobile.jpg');" >
