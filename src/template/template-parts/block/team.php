...
<section id="<?php echo $section_id; ?>" class='section uk-position-relative  uk-visible@m <?php if ($full_width) : ?> full-width<?php else : ?> <?php endif; ?>'>
                    ...
                    <div class=''>
                        ...
                        <div class='card_type-team uk-text-center'>
                            <?php if ($page_link) : ?>
                                ...
                                <h5 class="uk-margin-remove title"><?php echo $block_title; ?></h5>
                                <h6 class="uk-margin-remove caption "><?php echo $block_caption; ?></h6>
                                <small class="bio"><?php echo $block_content; ?></small>
                                <?php if ($page_link) : ?>
                                </a>
                            <?php endif; ?>
                        </div>
...
<!-- START section Service -->
<section id="<?php echo $section_id; ?>" class='section uk-position-relative uk-hidden@m <?php if ($full_width) : ?> full-width <?php else : ?> <?php endif; ?>'>
                ...
                <li>
                  ...
                  <div class='card_type-team uk-text-center'>
                            <?php if ($page_link) : ?>
                                ...
                                <h5 class="uk-margin-remove title"><?php echo $block_title; ?></h5>
                                <h6 class="uk-margin-remove caption "  style="color:#000"><?php echo $block_caption; ?></h6>
                                <small class="bio" style="color:#000"><?php echo $block_content; ?></small>
                                <?php if ($page_link) : ?>
                                </a>
                            <?php endif; ?>
                        </div>
