            ...
            <div class=''>
                ...
                <div class='card_type-footer'>
                    ...
                    <ul class="uk-list quick-link">
                        ...
                        <li class="uk-flex uk-flex-middle"><b>
                                <svg style="height: 20px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="map-marker-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-map-marker-alt fa-w-12">
                                    <path fill="currentColor" d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z" class=""></path>
                                </svg>
                            </b><?php echo $address; ?></li>
                    </ul>
                    <?php if (have_rows('social', 'options')) : ?>
                        ...
                        <div class="uk-flex">
                            <ul class="uk-iconnav social">
                                ...
                                <li><a href="https://www.facebook.com/MrFixItGD/">
                                        <svg style="width: 20px;" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-facebook-square fa-w-14">
                                            <path fill="currentColor" d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z" class=""></path>
                                        </svg>
                                    </a></li>
                                <li><a href="https://www.google.com/search?q=mr+fix+it+garage+door&amp;rlz=1C1SQJL_enEG867EG867&amp;oq=mr&amp;aqs=chrome.1.69i57j69i59j69i60l3j69i61j69i60j69i65.9695j0j4&amp;sourceid=chrome&amp;ie=UTF-8"><svg style="width: 20px;" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" class="svg-inline--fa fa-google fa-w-16">
                                ...
                                <li><a href="https://www.instagram.com/mrfixit_gd/"><svg style="width: 20px;" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-instagram fa-w-14">
