        ...
        <div class='uk-grid uk-child-width-1-3@m ' uk-grid="uk-margin">
                    ...
                    <?php if (have_rows('social', 'options')) : ?>
                        ...
                        <div class="uk-flex">
                            <ul class="uk-iconnav social">
                                ...
                                <li><a rel="noopener" href="https://www.instagram.com/mrfixit_gd/"><svg style="width: 20px;" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-instagram fa-w-14">
                                ...
                                <li><a rel="noopener" href="yelp.com/biz/mr-fix-it-garage-door-boynton-beach-3"><svg style="width: 20px;" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="yelp" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-yelp fa-w-12">
            ...
            <div class=''>
                ...
                <div class='card_type-footer'>
                    <h3>LOCATION</h3>
                    <?php if ($mapImage) : ?>
                        <a rel="noopener" href="<?php echo $mapImageURL ?>">
                            <!-- START mapiframe -->
...
<div class='uk-text-center'>
    ...
    <small> <?php echo $copyrights; ?> | Developed by <a rel="noopener" style="color:#fff;">xvxlabs.com</a></small>
</div>
<!-- END uk-text-center -->
            </div>
            <!-- END uk-container -->
