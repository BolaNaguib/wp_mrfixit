...
?> <!-- START section CARD --><div id="<?php echo $section_id;?>" class="section <?php if($full_width): ?> full-width <?php else: ?> <?php endif; ?> <?php if ($section_theme) : ?> section_theme-blue <?php else : ?> section_theme-white <?php endif; ?>"><!-- START uk-container --><div class="uk-container"> <?php if ($first_color || $second_color) : ?> <!-- START uk-text-center --><div class="uk-text-center"><h2 class="section__title"> <?php echo $first_color; ?><span> <?php echo $second_color; ?></span></h2></div><!-- END uk-text-center --> <?php endif; ?> <!-- START uk-grid --><div class="uk-grid uk-flex-middle" uk-grid="uk-margin"><!-- START uk-width-1-3@m uk-width-1-1 --><div class="uk-width-2-3@m uk-width-1-1"> <?php if ($content) : ?> <div class="card <?php if ($card_theme) : ?> card_theme_primary <?php else : ?> card_theme-white <?php endif; ?> "><h2 class="card__title"> <?php echo $card_title; ?> <span> <?php echo $city; ?> </span></h2><hr class="hr_type-small"> <?php echo $content; ?> <?php if (have_rows('lists')) : ?> <ul class="uk-grid uk-grid-small uk-child-width-1-2@m"> <?php while (have_rows('lists')) : the_row(); ?> <?php $list = get_sub_field( 'list' ); ?> <li class="uk-flex uk-flex-middle"><span><i class="fas fa-chevron-right"></i></span> <small><?php echo $list ;?></small></li> <?php endwhile; ?> </ul> <?php endif; ?> </div> <?php endif; ?> </div><!-- END uk-width-1-3@m uk-width-1-1 --><!-- START uk-wodth-1-3 --><div class="uk-width-1-3@m uk-width-1-1 uk-flex-last <?php if ($media_direction) : ?> uk-flex-first@m <?php endif; ?>"> <?php if ($media) : ?> <div class="img-border"><img src="<?php echo $media['url'] ?>" alt="<?php echo $media['alt'] ?> | <?php echo $city ;?> " title="<?php echo $media['title'] ?> | <?php echo $city ;?> "></div> <?php endif; ?> </div><!-- END uk-wodth-1-3 --></div><!-- END uk-grid --></div><!-- END uk-container --></div><!-- END section -->