...
<!-- START section Hero -->
<section class='section_type-hero uk-flex uk-flex-middle  <?php if ($full_width) : ?> full-width <?php else : ?> <?php endif; ?>' style="background-image: url('<?php echo $hero_background['url']; ?>');" >
